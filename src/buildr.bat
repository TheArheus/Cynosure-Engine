...
set CommonCompFlags=/std:c++latest /Zc:__cplusplus -fp:fast -nologo -MD -EHsc -Od -Oi -WX- -W4 -GR -Gm- -GS -FC -Zi -D_MBCS -wd4005 -wd4100 -wd4127 -wd4189 -wd4201 -wd4238 -wd4244 -wd4267 -wd4315 -wd4324 -wd4505 -wd4715
...
cl %CommonCompFlags% %UseDebugColorBlend% %DepthCascades% %GBufferCount% %LightSourcesMax% %VoxelGridSize% imgui.obj imgui_demo.obj imgui_draw.obj imgui_tables.obj imgui_widgets.obj renderer.lib ..\libs\freetype.lib user32.lib kernel32.lib gdi32.lib shell32.lib winmm.lib ..\src\core\platform\main.cpp ..\src\core\platform\win32\win32_main.cpp /I"..\src\core\vendor" /I"..\src" /Fe"Cynosure Engine" /link %CommonLinkFlags% /NODEFAULTLIB:libcmt /NODEFAULTLIB:msvcrt
popd
