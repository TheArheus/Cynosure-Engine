...
struct texture
{
	struct sampler
	{
		...
		sampler(VkDevice& Device, u32 MipLevelCount) 
		{
	...
	template<class T, class heap>
	texture(std::unique_ptr<T>& App, heap* Heap, u64 Offset, void* Data, u64 NewWidth, u64 NewHeight, u64 DepthOrArraySize = 1, const input_data& InputData = {VK_FORMAT_R8G8B8A8_UINT, VK_IMAGE_USAGE_STORAGE_BIT, VK_IMAGE_TYPE_2D, VK_IMAGE_VIEW_TYPE_2D, 1, 1, 0, false}): Width(NewWidth), Height(NewHeight), Depth(DepthOrArraySize)
	{
		Info = InputData;
		Device = App->Device;
		Sampler = sampler(Device, InputData.MipLevels);
	...
	template<class T, class heap>
	texture(std::unique_ptr<T>& App, heap* Heap, u64 Offset, u64 NewWidth, u64 NewHeight, u64 DepthOrArraySize = 1, const input_data& InputData = {VK_FORMAT_R8G8B8A8_UINT, VK_IMAGE_USAGE_STORAGE_BIT, VK_IMAGE_TYPE_2D, VK_IMAGE_VIEW_TYPE_2D, 1, 1, 0, false}): Width(NewWidth), Height(NewHeight), Depth(DepthOrArraySize)
	{
		Info = InputData;
		Device = App->Device;
		Sampler = sampler(Device, InputData.MipLevels);
	...
	template<class T>
	texture(std::unique_ptr<T>& App, void* Data, u64 NewWidth, u64 NewHeight, u64 DepthOrArraySize = 1, const input_data& InputData = {VK_FORMAT_R8G8B8A8_UINT, VK_IMAGE_USAGE_STORAGE_BIT, VK_IMAGE_TYPE_2D, VK_IMAGE_VIEW_TYPE_2D, 1, 1, 0, false}): Width(NewWidth), Height(NewHeight), Depth(DepthOrArraySize), Info(InputData)
	{
		Info = InputData;
		Device = App->Device;
		Sampler = sampler(Device, InputData.MipLevels);
	...
	template<class T>
	texture(std::unique_ptr<T>& App, u64 NewWidth, u64 NewHeight, u64 DepthOrArraySize = 1, const input_data& InputData = {VK_FORMAT_R8G8B8A8_UINT, VK_IMAGE_USAGE_STORAGE_BIT, VK_IMAGE_TYPE_2D, VK_IMAGE_VIEW_TYPE_2D, 1, 1, 0, false}): Width(NewWidth), Height(NewHeight), Depth(DepthOrArraySize), Info(InputData)
	{
		Info = InputData;
		Device = App->Device;
		Sampler = sampler(Device, InputData.MipLevels);
