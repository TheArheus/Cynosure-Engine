...
u32 GetVKShaderStageRev(u32 Stage)
{
	u32 Result = 0;

	if(Stage & VK_SHADER_STAGE_VERTEX_BIT)
		Result |= PSF_VertexShader;
	...
	if(Stage & VK_SHADER_STAGE_FRAGMENT_BIT)
		Result |= PSF_FragmentShader;
	if(Stage & VK_SHADER_STAGE_COMPUTE_BIT)
		Result |= PSF_Compute;
	if(Stage & VK_SHADER_STAGE_ALL)
		Result |= PSF_AllCommands;
...
bool IsVKAspectSupported(VkPipelineStageFlags StageMask, VkAccessFlags AccessFlag)
{
	switch (AccessFlag) 
	{
		case VK_ACCESS_INDIRECT_COMMAND_READ_BIT:
			return StageMask & VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT;

		case VK_ACCESS_INDEX_READ_BIT:
			return StageMask & VK_PIPELINE_STAGE_VERTEX_INPUT_BIT;

		case VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT:
			return StageMask & VK_PIPELINE_STAGE_VERTEX_INPUT_BIT;

		case VK_ACCESS_UNIFORM_READ_BIT:
			return StageMask & (VK_PIPELINE_STAGE_VERTEX_SHADER_BIT | 
		...
		case VK_ACCESS_INPUT_ATTACHMENT_READ_BIT:
			return StageMask & VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
		...
		case VK_ACCESS_COLOR_ATTACHMENT_READ_BIT:
			return StageMask & (VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT | 
		...
		case VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT:
			return StageMask & (VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT | 
			                    VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT);
		...
		case VK_ACCESS_MEMORY_READ_BIT:
			return StageMask & VK_PIPELINE_STAGE_ALL_COMMANDS_BIT;
