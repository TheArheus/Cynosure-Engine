...
g++ $CommonCompFlags $UseDebugColorBlend $DepthCascades $GBufferCount $LightSourcesMax $VoxelGridSize ../src/core/platform/main.cpp ../src/core/platform/other/linux_main.cpp -I../src/core/vendor -I../src -lfreetype -lxcb -lglfw -l:renderer.so -o "Cynosure Engine"
popd
