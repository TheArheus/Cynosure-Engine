...
void main()
{
	...
	IndirectDrawIndexedCommands[CommandIdx].FirstIndex    = 0; //MeshOffsets[CommandIdx].IndexOffset;
	IndirectDrawIndexedCommands[CommandIdx].IndexCount    = 0; //MeshOffsets[CommandIdx].IndexCount;
