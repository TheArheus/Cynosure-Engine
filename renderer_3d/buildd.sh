...
pushd ../build
g++ $CommonCompFlags $DepthCascades $UseDebugColorBlend $GBufferCount $LightSourcesMax $VoxelGridSize -I"../src" -I"../src/core/vendor" "../$GameModuleName/${GameModuleName}_game_module.cpp" $CommonLinkFlags -lassimp -shared -o "game_module.sce"
popd
