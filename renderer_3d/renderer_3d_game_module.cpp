...
ModuleStart()
{
	...
	EmmitObject.AddComponent<mesh_component>("../renderer_3d/assets/meshes/cube.obj", generate_aabb | generate_sphere);
	...
	Registry.GetSystem<deferred_raster_system>()->Setup(Gfx.Backend->Width, Gfx.Backend->Height, Window, WorldUpdate, MeshCompCullingCommonData);
...
ModuleUpdate()
{
	...
	ImGui::Checkbox("Enable debug colors", (bool*)&WorldUpdate.DebugColors);
	ImGui::Checkbox("Lock camera", (bool*)&IsCameraLocked);
